...
/**
 * Servlet implementation class PrincipalLivroServlet
 */
@WebServlet("/PrincipalLivroServlet")
public class PrincipalLivroServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrincipalLivroServlet() {
        super();
