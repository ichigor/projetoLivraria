...
/**
 * Servlet implementation class PrincipalVendedorServlet
 */
@WebServlet("/PrincipalVendedorServlet")
public class PrincipalVendedorServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrincipalVendedorServlet() {
        super();
